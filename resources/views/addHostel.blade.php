    ...
    <div class="container">
      ...
      <div class="justify-content-md-center ">
        ...
        <div>
          ...
          <form class="was-validated" action="/createHostel" method="POST">
            @csrf
            <div class="mb-3">
              <label for="validationTextarea" class="form-label">Hostel Name</label>
              <textarea class="form-control is-invalid " id="hostelName" name="hostel_name" placeholder="Enter the hostel name " required></textarea>
            ...
            <div class="mb-3">
              ...
              <input type="number" id="roomCount" name="no_room" class="form-control is-invalid" placeholder="Enter the capacity of the hostel" required/>
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input type="number" id="roomCapacity" name="room_capacity" class="form-control is-invalid" placeholder="Enter the capacity of the hostel" required/>
              <div class="invalid-feedback">
            ...
            <br><div class="mb-3">
              ...
              <textarea class="form-control is-invalid" name="address" id="address" placeholder="Enter the address of the hostel " required></textarea>
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input type="tel" id="roomCapacity" name="contact_no" class="form-control is-invalid" placeholder="Enter a 10 digit number" maxlength="10" minlength="10" required/>
              <div class="invalid-feedback">
